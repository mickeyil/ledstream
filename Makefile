...
CC := g++
CFLAGS := -g -Wall -Wno-sign-compare -Wno-deprecated-declarations -Wno-unused-function -std=c++0x -I src -I ../Eigen
...
MAIN_SRCS = src/rgb2hsv.cc src/test_eigen.cc
...
.PHONY: rgb2hsv test_eigen
rgb2hsv: $(TRG_rgb2hsv)
test_eigen: $(TRG_test_eigen)

all: rgb2hsv test_eigen
